...
namespace Bl.Migrations
{
    ...
    [Migration("20230804133703_addStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Domains.StatusJobBridge", b =>
                {
                    ...
                    b.HasKey("jobId", "StatusId");

                    b.ToTable("TbStatusJobBridge");
                });
            ...
            modelBuilder.Entity("JobStatusJobs", b =>
                {
                    ...
                    b.HasKey("jobsId", "statusId");

                    b.HasIndex("statusId");

                    b.ToTable("JobStatusJobs");
                });
            ...
            modelBuilder.Entity("JobStatusJobs", b =>
                {
                    b.HasOne("Domains.Jobs", null)
                        .WithMany()
                        .HasForeignKey("jobsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.Domains.JobStatus", null)
                        .WithMany()
